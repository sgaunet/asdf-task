...
# GitHub repository for go-task/task
readonly GH_REPO="https://github.com/go-task/task"
readonly TOOL_NAME="task"
readonly TOOL_TEST="task --version"

# Retry configuration for network operations
readonly MAX_RETRIES="${ASDF_TASK_MAX_RETRIES:-3}"
readonly RETRY_DELAY="${ASDF_TASK_RETRY_DELAY:-2}"

# Debug mode - set ASDF_TASK_DEBUG=1 to enable verbose logging
readonly DEBUG="${ASDF_TASK_DEBUG:-0}"
...
# Normalizes architecture names to match go-task naming conventions
...
verify_checksum() {
	local version="$1"
	local file_path="$2"
	local checksum_url="$GH_REPO/releases/download/v${version}/task_checksums.txt"
